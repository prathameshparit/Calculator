...
class Calculator:
	def __init__(self):
		...
		self.window.title("PP's Calci")
		self.window.iconbitmap(r'calci.ico')
	...
	def create_squarert_button(self):
		button = tk.Button(self.buttons_frame, text='\u221ax', bg=OFF_WHITE, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE, borderwidth=0, command=self.squarert)
